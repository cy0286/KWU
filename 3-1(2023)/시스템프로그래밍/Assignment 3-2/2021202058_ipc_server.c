///////////////////////////////////////////////////////////////////////////////
// File Name : 2021202058_ipc_server.c			    	     	     //
// Date :  2023/05/24			                                     //
...
// Description : Based on the proactive task, a fork function is used to     //
//	create child processes, and code is implemented using threads to     //
//	access shared memory. History records stored in shared memory are    //
//	printed in the latest order every 10 seconds, and the child process  //
//	stores history information in shared memory whenever the client      //
//	connects.	     			    			     //
///////////////////////////////////////////////////////////////////////////////
...
void handle_signal(int signal)
{
   ...
   if (signal == SIGINT) // SIGINT 시그널 핸들러
   {
      ...
      {
         printf("[%s] %d process is terminated.\n", time_str1, pids[i]); // 종료된 자식 프로세스 상태 출력
      }
...
int main(int argc, char **argv)
{
   ...
   addrlen = sizeof(client_addr);                          // 클라이언트 주소 구조체 크기 저장                      // 클라이언트 주소 구조체 크기 저장
