...
#define MAX_RETURN_SECONDS 10  // Maximum return period for books (in seconds)

// Function to set the return due date for borrowed books
void SetReturnDueDate(INT32U* return_due)
{
    *return_due = OSTimeGet() + (MAX_RETURN_SECONDS * OS_TICKS_PER_SEC); // Set the return due date by adding 10 seconds to the current time
}
